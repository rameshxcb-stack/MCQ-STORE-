...
async function executeHttp(
  ...
  // This confirms that this direct-HTTP db.js is running on Vercel.
  console.log(
  ...
  // IMPORTANT:
  // Turso pipeline execute result is nested under
  // first.response.result in the normal response.
  const executeResult =
...
export function getDbDiagnostics() {
  try {
    ...
    try {
      ...
      // Safe protocol detection for both libsql:// and https://.
      protocol =
        url.startsWith('libsql://')
          ? 'libsql:'
          : parsed.protocol;
